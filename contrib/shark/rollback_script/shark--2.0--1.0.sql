...
DROP CAST IF EXISTS (sys.VARBINARY AS sys.VARBINARY) CASCADE;
DROP CAST IF EXISTS (pg_catalog.BYTEA AS sys.VARBINARY) CASCADE;
DROP CAST IF EXISTS (sys.VARBINARY AS pg_catalog.BYTEA) CASCADE;
DROP CAST IF EXISTS (pg_catalog.VARCHAR AS sys.VARBINARY) CASCADE;
DROP CAST IF EXISTS (pg_catalog.BPCHAR AS sys.VARBINARY) CASCADE;
DROP CAST IF EXISTS (sys.VARBINARY AS pg_catalog.BPCHAR) CASCADE;
DROP CAST IF EXISTS (sys.VARBINARY AS pg_catalog.VARCHAR) CASCADE;
DROP CAST IF EXISTS (INT2 AS sys.VARBINARY) CASCADE;
DROP CAST IF EXISTS (INT4 AS sys.VARBINARY) CASCADE;
DROP CAST IF EXISTS (INT8 AS sys.VARBINARY) CASCADE;
DROP CAST IF EXISTS (REAL AS sys.VARBINARY) CASCADE;
DROP CAST IF EXISTS (DOUBLE PRECISION AS sys.VARBINARY) CASCADE;
DROP CAST IF EXISTS (sys.VARBINARY as INT2) CASCADE;
DROP CAST IF EXISTS (sys.VARBINARY as INT4) CASCADE;
DROP CAST IF EXISTS (sys.VARBINARY as INT8) CASCADE;
DROP CAST IF EXISTS (sys.VARBINARY as numeric) CASCADE;
DROP CAST IF EXISTS (numeric AS sys.VARBINARY) CASCADE;
DROP CAST IF EXISTS (sys.VARBINARY as date) CASCADE;
DROP CAST IF EXISTS (date AS sys.VARBINARY) CASCADE;
DROP CAST IF EXISTS (sys.VARBINARY as time) CASCADE;
DROP CAST IF EXISTS (time AS sys.VARBINARY) CASCADE;
DROP CAST IF EXISTS (sys.VARBINARY as smalldatetime) CASCADE;
DROP CAST IF EXISTS (smalldatetime AS sys.VARBINARY) CASCADE;
...
drop function if exists sys.isnull(text,smallint);
drop function if exists sys.isnull(text,integer);
drop function if exists sys.isnull(text,bigint);
drop function if exists sys.isnull(text,real);
drop function if exists sys.isnull(text,double precision);
drop function if exists sys.isnull(text,numeric);
...
drop function if exists sys.shark_conv_helper_to_varbinary(IN typmod INTEGER, IN arg anyelement, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_varbinary(IN typmod INTEGER, IN arg VARCHAR, IN p_try BOOL, IN p_style NUMERIC);
...
drop function if exists sys.shark_conv_helper_to_datetimeoffset(IN typmod INTEGER, IN arg TEXT, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_datetimeoffset(IN typmod INTEGER, IN arg VARCHAR, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_datetimeoffset(IN typmod INTEGER, IN arg NVARCHAR2, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_datetimeoffset(IN typmod INTEGER, IN arg BPCHAR, IN p_try BOOL, IN p_style NUMERIC);

drop function if exists sys.shark_conv_helper_to_smalldatetime(IN typmod INTEGER, IN arg TEXT, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_smalldatetime(IN typmod INTEGER, IN arg VARCHAR, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_smalldatetime(IN typmod INTEGER, IN arg NVARCHAR2, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_smalldatetime(IN typmod INTEGER, IN arg BPCHAR, IN p_try BOOL, IN p_style NUMERIC);
...
drop function if exists sys.shark_conv_helper_to_date(IN arg TEXT, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_date(IN arg VARCHAR, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_date(IN arg NVARCHAR2, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_date(IN arg BPCHAR, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_date(IN arg anyelement, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_time(IN typmod INTEGER, IN arg TEXT, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_time(IN typmod INTEGER, IN arg VARCHAR, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_time(IN typmod INTEGER, IN arg BPCHAR, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_time(IN typmod INTEGER, IN arg NVARCHAR2, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_datetime2(IN typmod INTEGER, IN arg TEXT, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_datetime2(IN typmod INTEGER, IN arg VARCHAR, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_datetime2(IN typmod INTEGER, IN arg NVARCHAR2, IN p_try BOOL, IN p_style NUMERIC);
drop function if exists sys.shark_conv_helper_to_datetime2(IN typmod INTEGER, IN arg BPCHAR, IN p_try BOOL, IN p_style NUMERIC);
